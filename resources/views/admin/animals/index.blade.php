            ...
            <section class="list">
                ...
                <div class="list__categories">
                    ...
                    @foreach ($categories as $category)
                        <a href="{{ route('animals.index', array_merge(request()->query(), ['breed' => $category], ['name' => ''])) }}"
                            class="list__category {{ strtolower(request('breed')) == strtolower($category) ? 'list__key--active' : '' }}">
                            {{ $category }}
                        </a>
                    @endforeach
                    <a href="{{ route('animals.index', array_merge(request()->query(), ['gender' => 'male'], ['name' => ''])) }}"
                        class="list__key {{ request('gender') == 'male' ? 'list__key--active' : '' }}">
                        М
                    </a>
                    <a href="{{ route('animals.index', array_merge(request()->query(), ['gender' => 'female'], ['name' => ''])) }}"
